...
type ActionType = 'timer:scheduled_task' | 'reddit:poll_rss' | 'github:issues' | 'github:branches' | 'github:pushes' | 'github:pulls' | 'github:stars' | 'github:releases'| 'docker:watch_webhook' | 'google:poll_mailbox'| 'google:search_emails';
