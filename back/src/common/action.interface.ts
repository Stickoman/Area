...
type ActionType = 'timer:scheduled_task' | 'reddit:poll_rss' | 'github:issues' | 'github:branches' | 'github:pushes' | 'github:pull' | 'docker:watch_webhook'| 'google:poll_mailbox'| 'google:search_emails';
